...
{% include notification.html message="Submission: The checkpoints are handled a little differently for this lab. The first checkpoint will consist of a  written document that must be submitted via Blackboard before class on October 22nd. The second checkpoint is the in-class debate on October 22nd."
status="is-success"
...
Start by forming a team with other class members (teams of 2 or 3) and pick one of the **prompts** provided in the next section. Then, your team must pick a side -- affirmative or negative -- and begin to build an argument around that position (more details on building the argument are found later in this document).

After you form a team, your team must sign up for a prompt and affirmative/negative positions in
[this spreadsheet](https://wmedu-my.sharepoint.com/:x:/g/personal/adwoodlief_wm_edu/EaimUEIza2BDipP2d6sBND0BSkWx-pjNIPo4GsgZBNquCA?e=MD8Tft).
The link is visible to anyone who is logged into their W&M OneDrive account,
Signup is on a first come, first served basis, so sign up quickly if you see a prompt you really like.
...
1. Should [sentient robots](https://www.nbcnews.com/mach/tech/what-rise-sentient-robots-will-mean-human-beings-ncna773146) have the same rights as humans?
2. Should a [caretaking/personal assistant robot](https://ieeexplore.ieee.org/abstract/document/5980058?casa_token=V_F525cBorwAAAAA:3_PgIxa4xJ2ne9vSWF_hKAGK6s7JrADljtNiuG42-5ZjcNPGjiZYGvAmDMk3YlOxgMha85uv) have control over the daily activities of their human (food, medicine, exercise, bedtime/waking time, etc.)?
3. Should [law enforcement agencies use robots](https://builtin.com/robotics/police-robot-law-enforcement) to uphold the law?
...
1. At least two news articles that characterize the ways in which the target problem is present today.  Examples of this might be the Vox article on [social robots for the elderly](https://www.vox.com/future-perfect/2020/9/9/21418390/robots-pandemic-loneliness-isolation-elderly-seniors).

2. At least one peer-reviewed writing such as a research article, journal, or book on ethics/fairness/discrimination in a field related to your prompt to back up your debate position. An example of this might be the [ACM paper](https://dl.acm.org/doi/pdf/10.1145/3526105) mentioned earlier.
...
4. One **well-known** sci-fi/futuristic work of fiction that incorporates robots to use as a framing device for the future consequences or implications of the position you or your opponent may take on the prompt. Favor ones with which your audience may be familiar. For example, we might assume that most people have seen *2001: A Space Odyssey* and are passingly familiar with the concept of a robot controlling a spaceship, but most people are not familiar with the Kubrickian interpretation of the ending in which the main character is supposedly held captive in an alien zoo.
...
With your team, write up a 2 to 3-page writeup, in the format described below, of your position and how you intend to argue it, with all relevant sources cited. Each team will submit exactly one outline, but be sure to include the names of all team members in the submission.

Your writeup must begin with a 1-2 paragraph abstract/summary of your position and the broad themes for how you will argue this position.
Then, you must outline your position using bullet points with a level of detail similar to the ones shown above (but more bullet points than the above), so you can easily reference this outline during your debate. Although not shown above, you must include citations where relevant so that you can reference them during the debate. For example, "Researchers at Tufts showed that..." is stronger than "It has been shown that..."
In this outline, organize your arguments to address (at least) the following questions:
...
Include a list of references at the end in a standard reference format. This must include the title of the reference, the authors, the publisher, and a link to the source.

**This checkpoint must be submitted through Blackboard before the in-lab debate (October 22, 2025).** Part of the grade for this lab is based on how well you've prepared. The writeup will form 60% of the lab grade.


## Part 2: Debate
On the day of the lab, teams on opposite sides of the same prompt will debate each other and a winner(s) will be chosen by the moderators and audience.
*Winning your debate won't affect your ability to earn a 100% on this lab, but it will earn you extra credit towards your lab grade.*

Each debate will be ~12 minutes long, broken down into an introduction to the topic, timed rebuttals, and a period of question-and-answer from the moderators and audience. At the end of the debate, the class will vote on a winner and the moderators will select a winner, and the winning team(s) will earn 5 points of extra credit towards their lab grade.
...
* Q&A Representative (hereby referred to as "Student3X" for team X; for teams of 2, they will split this duty)
...
5. Questions from moderators and audience, answered by Student3A and Student3B: 2-4 minutes
...
1. The speakers’ statements clearly supported their position. (10%)
2. Arguments were presented with clarity and appropriate volume.  (10%)
3. Rebuttals were specific to opposing arguments and expressed with clarity.  (10%)
4. Answers during Q&A were precise and thoughtful.  (10%)
5. Winner(s) as per moderator decision and audience decision (+5% extra credit)
