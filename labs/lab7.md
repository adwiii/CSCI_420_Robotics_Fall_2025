...
<div class="columns is-centered">
    <div class="column is-centered is-4">
        <figure class="image">
        <img src="../images/lab7/drone_world_transform.png">
        </figure>
    </div>
</div>
...
<div class="columns is-centered">
    <div class="column is-centered is-8">
        <figure class="image">
        <img src="../images/lab7/cp2_system_diagram.png">
        </figure>
    </div>
</div>
...
When we used `t = self.tf_buffer.lookup_transform('world', 'tower', rclpy.time.Time())` with the static transform, the last argument, `rclpy.time.Time()`, did not matter - the transformation would always be the same. However, with dynamic transformations, the transform time is very important. Using `rclpy.time.Time()` asks `tf2` for the most recent transform. Internally `tf2` maintains a lookup that uses the parent frame, child frame, and time as keys to retrieve the required transform.
...
<div class="columns is-centered">
    <div class="column is-centered is-8">
        <figure class="image">
        <img src="../images/lab7/transformStamped.png">
        </figure>
    </div>
</div>
...
**Step 1:** Skeleton code has alreayd been provided in `world_to_drone.py` in the `simple_control` package.
...
**Step 1:** Skeleton code is provided in the file `ground_robot_controller.py` in the `simple_control` package.
...
<div class="columns is-centered">
    <div class="column is-centered is-6">
        <figure class="image">
        <img src="../images/lab7/wobble.gif">
        </figure>
    </div>
</div>
...
You should now be able to re-run the simulator and observe that the ground robot follows the drone more closely and with less noise.
 ...
 <div class="columns is-centered">
    <div class="column is-centered is-6">
        <figure class="image">
        <img src="../images/lab7/stabilized.gif">
        </figure>
    </div>
</div>
